...
import (
	...
	_ "github.com/Clov614/rikka-bot-wechat/rikkabot/old_plugins" // 需要副作用
	"github.com/Clov614/rikka-bot-wechat/rikkabot/old_processor/cache"
	dpkg "github.com/Clov614/rikka-bot-wechat/rikkabot/old_processor/control/dialog"
...
func (p *Processor) Close() {
	...
	p.Cache.Close() // 关闭缓存
	logging.Info("old_processor closed")
}
